...
apigClientFactory.newClient = function (config) {
    ...
    if(config === undefined) {
        config = {
            accessKey: 'AKIAR34BPQR66N5CC7EC',
            secretKey: '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',
            sessionToken: '',
            region: '',
            apiKey: undefined,
    ...
    var invokeUrl = 'https://s24w0ue4pl.execute-api.us-east-1.amazonaws.com/dev';
